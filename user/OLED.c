...
************************************************************************/
  ...
  #define OLED_SCL  PTE7_OUT   //
  #define OLED_SDA  PTE6_OUT        
//  #define OLED_RST  PTC15_OUT
  #define OLED_DC   PTE4_OUT
  #define OLED_CS   PTE5_OUT
...
void OLED_show()
{
 ...
 /* u8 e[3]={0};
  u8 f[3]={0};*/
 /* 
  ch[0]=((u8)L_Line_1[0])/100 + 48;
  ch[1]=((u8)L_Line_1[0])%100/10 + 48;
  ch[2]=((u8)L_Line_1[0])%10 + 48;
  
  ab[0]=((u8)R_Line_1[0])/100 + 48;
  ab[1]=((u8)R_Line_1[0])%100/10 + 48;
  ab[2]=((u8)R_Line_1[0])%10 + 48;  
  
  c[0]=((u8)Track_C_Line_1[0])/100 + 48;
  c[1]=((u8)Track_C_Line_1[0])%100/10 + 48;
  c[2]=((u8)Track_C_Line_1[0])%10 + 48;    
  
  d[0]=((u8)pid_out)/100 + 48;
  d[1]=((u8)pid_out)%100/10 + 48;
  d[2]=((u8)pid_out)%10 + 48;  */  
/*
  e[0]=MAX_NUM/100 + 48;
  e[1]=MAX_NUM%100/10 + 48;
  e[2]=MAX_NUM%10 + 48;     
  
  f[0]=MIN_NUM/100 + 48;
  f[1]=MIN_NUM%100/10 + 48;
  f[2]=MIN_NUM%10 + 48;     
*/ 
  OLED_P8x16Str(55,0,ch);   //OLED_P8x16Str(70,0,e);  
  OLED_P8x16Str(55,2,ab);   //OLED_P8x16Str(70,2,f);
  OLED_P8x16Str(60,4,c);  
  OLED_P8x16Str(80,6,d); 
  
   OLED_P8x16Str(5,0,"left:");
   OLED_P8x16Str(5,2,"right:");
   OLED_P8x16Str(5,4,"Center:");
   OLED_P8x16Str(5,6,"pid_out:");  
